...
internal static class DiscoveryCommands
{
    ...
    /// <param name="add">Projected add mutations as semicolon-separated path=value clauses.</param>
    /// <param name="remove">Projected remove mutations as semicolon-separated path=value clauses.</param>
    /// <param name="set">Projected set mutations as semicolon-separated path=value clauses.</param>
