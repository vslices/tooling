...
internal sealed record DocsStandardSnapshotPreparationResult(bool IsSuccess, string? Error)
{
...
{
    public static DocsStandardSnapshotPreparationResult Prepare(string materializedRoot, string preparedRoot)
    {
        ...
        if (Directory.Exists(preparedRoot)) Directory.Delete(preparedRoot, recursive: true);
    ...
    public static void Replace(string vslicesRoot, string preparedRoot)
    {
        ...
        {
            if (Directory.Exists(backup) && Directory.Exists(target)) Directory.Delete(backup, recursive: true);
        }
    }

    private static void CopyOptionalDefinitionDirectory(string materializedRoot, string preparedRoot, string directoryName)
    {
