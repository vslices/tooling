...
| ¿Qué códigos internos usaremos para los errores esperados? | Los códigos internos comenzarán desde el 1, siendo este ultimo reservado para "Errores de consistencia" y crecerán secuencialmente a medida que se necesiten nuevos errores. |
