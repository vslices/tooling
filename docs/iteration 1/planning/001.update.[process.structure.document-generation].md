...
<!--
Status: draft, proposal, active, resolved, superseded, or archived.
...
Este documento actualiza [la estructura del proceso actual de generación de documentos](../contextualizing/process.structure.document-generation.md)
